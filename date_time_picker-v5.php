...
{
    /** @var string $name */
    public $name = 'date_time_picker';

    /** @var string $domain */
    public $domain = 'acf-field-date-time-picker';
     ...
     * @date 23/01/13
     *
     * @param string $field - an array holding all the field's data
     */
    public function render_field_settings($field)
    {
        ...
        acf_render_field_setting($field, array(
            ...
            'instructions' => sprintf(__("Most users should leave this untouched, only set it to \"Yes\" if you need get the  date and time field as a timestamp using  <a href=\"%s\" target=\"_blank\">the_field()</a> or <a href=\"%s\" target=\"_blank\">get_field()</a> ", $this->domain), "http://www.advancedcustomfields.com/resources/functions/the_field/",
     ...
     * @return string
     */
    public function js_to_php_dateformat($date_format)
    {
        $chars = array(
            // Day
            'dd' => 'd',
     ...
     * @return string
     */
    public function js_to_php_timeformat($time_format)
    {
        $chars = array(
            //hour
            'HH' => 'H',
     ...
     * @param string $field - the field array holding all the field options
     *
    ...
    public function input_admin_enqueue_scripts()
    {
        ...
        wp_enqueue_script('jquery-ui-timepicker', $this->dir . 'js/jquery-ui-timepicker-addon.js', array('acf-input', 'jquery-ui-slider'), $this->version, true);

        if (file_exists($this->dir . 'js/localization/jquery-ui-timepicker-' . $js_locale . '.js')) {
            wp_enqueue_script('timepicker-localization', $this->dir . 'js/localization/jquery-ui-timepicker-' . $js_locale . '.js', array('jquery-ui-timepicker'), $this->version, true);
            wp_enqueue_script('timepicker', $this->dir . 'js/timepicker.js', array('timepicker-localization'), $this->version, true);
            $has_locale = true;
        } else {
            wp_enqueue_script('timepicker', $this->dir . 'js/timepicker.js', array('jquery-ui-timepicker'), $this->version, true);
        }
        ...
        wp_enqueue_style('jquery-style', $this->dir . 'css/jquery-ui.css', array('acf-datepicker'), $this->version);
        wp_enqueue_style('timepicker', $this->dir . 'css/jquery-ui-timepicker-addon.css', array('jquery-style'), $this->version);
    }
     ...
     * @return string
     */
    public function get_js_locale($locale)
    {
     ...
     * @return array|mixed
     */
    public function ps_preg_filter($pattern, $replace, $subject, $limit = -1, &$count = 0)
    {
